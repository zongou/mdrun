...
var languageConfigs = map[string]languageConfig{
	"awk":        {"awk", []string{"$CODE"}},
	"sh":         {"sh", []string{"-c", "$CODE", "--"}},
	"bash":       {"bash", []string{"-c", "$CODE", "--"}},
	"zsh":        {"zsh", []string{"-c", "$CODE", "--"}},
	"fish":       {"fish", []string{"-c", "$CODE", "--"}},
	"dash":       {"dash", []string{"-c", "$CODE", "--"}},
	"ksh":        {"ksh", []string{"-c", "$CODE", "--"}},
	"ash":        {"ash", []string{"-c", "$CODE", "--"}},
	"shell":      {"sh", []string{"-c", "$CODE", "--"}},
